...
@section('title', 'Edit Tipe Opsi')
@section('page-title', 'Edit Tipe Opsi')
@section('page-subtitle', 'Perbarui kategori kustomisasi')

@section('content')
<div class="max-w-2xl mx-auto animate-fade-in-up">
    <div class="bg-white rounded-3xl border border-gray-100 shadow-card p-8">
        <form action="{{ route('admin.tipe-opsi.update', $tipeOpsi) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input type="text"
                       id="nama_tipe"
                       name="nama_tipe"
                       value="{{ old('nama_tipe', $tipeOpsi->nama_tipe) }}"
                       required
                       maxlength="50"
            ...
            <div class="space-y-4 mb-8">
                <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    <input type="checkbox"
                           ...
                           name="wajib_pilih"
                           value="1"
                           {{ old('wajib_pilih', $tipeOpsi->wajib_pilih) ? 'checked' : '' }}
                ...
                <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    <input type="checkbox"
                           ...
                           name="pilih_banyak"
                           value="1"
                           {{ old('pilih_banyak', $tipeOpsi->pilih_banyak) ? 'checked' : '' }}
                           class="w-5 h-5 text-primary border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/20
                                  checked:bg-primary checked:border-primary transition-all cursor-pointer">
            ...
            <div class="mb-6">
                ...
                <input type="number"
                       id="urutan"
                       name="urutan"
                       value="{{ old('urutan', $tipeOpsi->urutan) }}"
                       min="0"
                       class="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl
                              focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/20
                              transition-all duration-200 text-gray-900 placeholder-gray-400
