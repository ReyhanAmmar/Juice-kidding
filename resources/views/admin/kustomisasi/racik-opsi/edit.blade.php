...
@section('title', 'Edit Opsi Racik Sendiri')
@section('page-title', 'Edit Opsi Racik Sendiri')
@section('page-subtitle', 'Perbarui opsi Racik Sendiri')

@section('content')
<div class="max-w-2xl mx-auto animate-fade-in-up">
    <div class="bg-white rounded-3xl border border-gray-100 shadow-card p-8">
        <form action="{{ route('admin.racik-opsi.update', $opsi->id_opsi) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <select name="id_tipe_opsi" id="id_tipe_opsi" required
                    ...
                    <option value="{{ $tipe->id_tipe_opsi }}" {{ old('id_tipe_opsi', $opsi->id_tipe_opsi) == $tipe->id_tipe_opsi ? 'selected' : '' }}>
                        {{ $tipe->nama_tipe }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nama_opsi" name="nama_opsi" value="{{ old('nama_opsi', $opsi->nama_opsi) }}"
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <input type="number" id="harga_tambahan" name="harga_tambahan"
                           value="{{ old('harga_tambahan', $opsi->harga_tambahan) }}" min="0" required
            ...
            <div class="mb-6">
                ...
                <input type="number" id="urutan" name="urutan" value="{{ old('urutan', $opsi->urutan) }}" min="0"
                       class="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl
                              focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/20
            ...
            <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100 mb-8">
                <input type="checkbox" name="is_active" id="is_active" value="1"
                       {{ old('is_active', $opsi->is_active) ? 'checked' : '' }}
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-100">
                ...
                <button type="submit"
                    ...
                    <i data-lucide="save" class="w-5 h-5"></i> Update Opsi
                </button>
            </div>
        </form>
    </div>
